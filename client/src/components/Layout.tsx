          ...
          {user ? (
            <nav aria-label="Main navigation" className="flex items-center gap-1.5">
              ...
              <div className="ml-3 flex items-center gap-2.5 border-l border-slate-200 dark:border-slate-800 pl-3">
                ...
                <div 
                  className="flex h-8 w-8 items-center justify-center rounded-full bg-brand-100 dark:bg-brand-900/60 text-sm font-bold text-brand-700 dark:text-brand-300" 
                  aria-hidden="true"
                >
                  {initials}
                </div>
